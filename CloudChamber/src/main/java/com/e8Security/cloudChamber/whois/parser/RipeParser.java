...
public class RipeParser extends IPParser{
	...
	private final static Logger logger=LoggerFactory.getLogger(RipeParser.class);
...
static{
	  ...
	  RIPE_PARSE_MAP.put("irt",ParsingPattern.WHOIS_ORGNAME_PATTERN);
	  ...
	  RIPE_PARSE_MAP.put("role",ParsingPattern.WHOIS_ORGTECHNAME_PATTERN);
	  ...
	  RIPE_PARSE_MAP.put("created",ParsingPattern.WHOIS_REGDATE_PATTERN);
