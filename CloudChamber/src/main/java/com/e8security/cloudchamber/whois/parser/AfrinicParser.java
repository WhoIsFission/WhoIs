...
public class AfrinicParser extends IPParser{
	...
	static{
		  ...
		  AFRINIC_PARSE_MAP.put("irt",ParsingPattern.WHOIS_ORGNAME_PATTERN);
		  ...
		  AFRINIC_PARSE_MAP.put("role",ParsingPattern.WHOIS_ORGTECHNAME_PATTERN);
		  ...
		  AFRINIC_PARSE_MAP.put("created",ParsingPattern.WHOIS_REGDATE_PATTERN);
	}
