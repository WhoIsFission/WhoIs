...
public class LacnicParser extends IPParser{
	...
	static{
		  LACNIC_PARSE_MAP.put("inetnum",ParsingPattern.WHOIS_NETRANGE_PATTERN);
		  LACNIC_PARSE_MAP.put("origin",ParsingPattern.WHOIS_ORIGINASN_PATTERN);
		  LACNIC_PARSE_MAP.put("netname",ParsingPattern.WHOIS_NETNAME_PATTERN);
		  LACNIC_PARSE_MAP.put("aut-num",ParsingPattern.WHOIS_ORIGINASN_PATTERN);
		  ...
		  LACNIC_PARSE_MAP.put("org-name",ParsingPattern.WHOIS_ORGNAME_PATTERN);
		  LACNIC_PARSE_MAP.put("irt",ParsingPattern.WHOIS_ORGNAME_PATTERN);
	      LACNIC_PARSE_MAP.put("owner",ParsingPattern.WHOIS_ORGNAME_PATTERN);
		  LACNIC_PARSE_MAP.put("org",ParsingPattern.WHOIS_ORGID_PATTERN);
		  LACNIC_PARSE_MAP.put("ownerid",ParsingPattern.WHOIS_ORGID_PATTERN);
		  ...
		  LACNIC_PARSE_MAP.put("role",ParsingPattern.WHOIS_ORGTECHNAME_PATTERN);
		  ...
		  LACNIC_PARSE_MAP.put("created",ParsingPattern.WHOIS_REGDATE_PATTERN);
		 ...
		 */
			...
			private WhoIsNode<Long> caseParsing(String aPattern,String aValue,WhoIsNode<Long> node,String aType) throws ParseException {
				...
				if(pattern!=null&&aType!=null){
					if(logger.isDebugEnabled())
						logger.debug("Started parsing for pattern: "+pattern.toString());
				switch(pattern){
				  ...
				  case  WHOIS_ORGCOUNTRY_PATTERN:
					  ...
					  if("ORGANISATION".equalsIgnoreCase(aType)||"NETBLOCK".equalsIgnoreCase(aType))
				  ...
				  case WHOIS_ORIGINASN_PATTERN:
					...
					//  node.setOriginAS(aValue);TODO route info
					  if("ASN".equalsIgnoreCase(aType)||"NETBLOCK".equalsIgnoreCase(aType)){
				  ...
				  case WHOIS_ORGADDRESS_PATTERN:
					  ...
					  else if("ORGANISATION".equalsIgnoreCase(aType)||"NETBLOCK".equalsIgnoreCase(aType)){
